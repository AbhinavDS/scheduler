...
db.define_table('usertables',Field('username',db.auth_user),Field('tNo',db.timetables,unique=True),Field('tablename','string'))
...
auth.settings.login_next = URL('mainpage.html')
